...
- **Milestone dogfood pending (developer):** `make smoke` for instant verification, then a real browser pass when convenient. **Next:** PR-M2 (core), PR-G2+ (learner memory, see `agent_memory_sota.md`), T/V registered.
