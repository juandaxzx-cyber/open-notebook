...
### Feature G — Cross-Session Memory (spaced review is one part) — G1 ✅ merged 2026-07-14; G2 ✅ merged 2026-07-18 (@2dbc60d, incl. audit fix: merge integrates prior note, never overwrites); G3 contract signed 2026-07-19 (SM-2 + horizon eviction + visible decay; playbook §1, in implementation — completes Feature G, then milestone dogfood; nothing memory-consuming contracts before that dogfood)
