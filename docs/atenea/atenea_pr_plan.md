...
### Feature G — Cross-Session Memory (spaced review is one part) — G1 ✅ merged 2026-07-14; G2 ✅ merged 2026-07-18 (@2dbc60d, incl. audit fix: merge integrates prior note, never overwrites); G3 (retention-aware forgetting) next
